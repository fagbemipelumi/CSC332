 ...
 * @author cjae
 */
public class ChangePasswordFrame extends javax.swing.JDialog {

    /**
     * Creates new form ChangePasswordFrame
     */
    public ChangePasswordFrame(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChangePasswordFrame dialog = new ChangePasswordFrame(new javax.swing.JFrame(), true);
